  ...
  return (
    <div className="min-h-screen bg-white p-10 print:p-6 text-[#2b2b2b] relative">
      <img
        ...
        alt=""
        aria-hidden="true"
        className="fixed inset-0 m-auto w-[75vmin] h-[75vmin] object-contain opacity-[0.06] pointer-events-none select-none print:absolute"
      />
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="mt-10">
          <div className="flex justify-end mb-4">
            <div className="w-[300px]">
              <div className="flex justify-between items-center mb-4 px-3">
                ...
                <span className="font-bold text-[16px]">{formatCurrency(invoice.subtotal)}</span>
              </div>
              <div className="flex justify-between items-center px-3">
                <span className="font-bold text-[16px]">TVA 20% :</span>
                <span className="font-bold text-[16px]">{formatCurrency(invoice.total - invoice.subtotal)}</span>
              </div>
            </div>
          </div>
          <div className="bg-[#1a1a1a] text-white px-5 py-3.5 flex justify-between items-center w-full">
            ...
            <span className="font-bold text-[16px]">{formatCurrency(invoice.total)}</span>
          </div>
        </div>
